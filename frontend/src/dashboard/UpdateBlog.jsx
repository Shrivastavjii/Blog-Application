  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const { data } = await axios.put(
        `https://blog-application-0g90.onrender.com/api/blogs/update/${id}`,
        formData,
        {
          withCredentials: true,
          headers: {
  ...
  return (
    <div>
      <div className="container mx-auto my-12 p-4">
        ...
        <section className="max-w-2xl mx-auto border-white">
          <h3 className="text-2xl font-bold mb-6">UPDATE BLOG</h3>
          <div className="bg-slate-800 rounded-lg py-4 px-6">
          <form>
            ...
            <div className="mb-4">
              ...
              <img
                src={
                  blogImagePreview
                    ? blogImagePreview
                    : blogImage?.url // agar object { url }
                      ? blogImage.url
                      : typeof blogImage === "string" // agar string URL
                        ? blogImage
                        : "/imgPL.webp"
                }
                alt="Blog Main"
